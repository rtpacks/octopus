...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, KeyRound } from 'lucide-react';
...
const OAuth_Module = lazyWithPreload(() => import('@/components/modules/oauth').then(m => ({ default: m.OAuth })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'oauth', label: 'OAuth', icon: KeyRound, component: OAuth_Module },
